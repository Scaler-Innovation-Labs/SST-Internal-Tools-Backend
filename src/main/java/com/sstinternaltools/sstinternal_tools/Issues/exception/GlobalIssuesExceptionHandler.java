...
public class GlobalIssuesExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleInvalidTicketDataException(InvalidTicketDataException ex) {
        ErrorResponse errorResponse = new ErrorResponse(
    ...
    public ResponseEntity<ErrorResponse> handleUnauthorizedTicketAccessException(UnauthorizedTicketAccessException ex) {
        ErrorResponse errorResponse = new ErrorResponse(
